...
@aicos_union.route('/admin/coops/dashboard_overall')
@login_required
...
@aicos_union.route('/admin/dashboard_cooperative')
@login_required
def dashboard_coop():
    #check_admin()
    #check_coop_admin()
...
@aicos_union.route('/cooperative_details/<string:email>', methods=['GET', 'POST'])
@login_required
...
@aicos_union.route('/cooperative/umusaruro/<string:email>')
@login_required
...
@aicos_union.route('/cooperative/inyongeramusaruro/<string:email>')
@login_required
...
@aicos_union.route('/cooperative/imisanzu/<string:email>')
@login_required
...
@aicos_union.route('/cooperative/ibirarane/<string:email>')
@login_required
...
@aicos_union.route('/cooperative/ibihano/<string:email>')
@login_required
...
@aicos_union.route('/cooperative/ibindi/<string:email>')
@login_required
