...
class UnionForm(FlaskForm):
    ...
    """
    Code = StringField(u'Code ya Union', validators=[DataRequired()], render_kw={"placeholder": "Injiza Code ya Union"})
    Name = StringField(u'Izina rya Union', validators=[DataRequired()], render_kw={"placeholder": "Injiza izina rya Union"})
    RegDate = StringField(u'Igihe Union yandikiwe', validators=[DataRequired()], render_kw={"placeholder": "Injiza italiki yandikiweho"})
    Certificate = StringField(u'Certificate ya Union', validators=[DataRequired()], render_kw={"placeholder": "Shyiramo certificate ya Union"})
    ...
    Sector = StringField('Injiza umurenge Union ibarizwamo', validators=[DataRequired()], render_kw={"placeholder": "Injiza umurenge Union ibarizwamo"})
    Cell = StringField('Injiza akagari Union ibarizwamo', validators=[DataRequired()], render_kw={"placeholder": "Injiza akagari Union ibarizwamo"})
    ...
    Field = SelectField(
        'Hitamo umurimo Union ikora',
        choices=[('Umurimo Union ikora', 'Umurimo Union ikora'),('Ubuhinzi bw\'Icyayi', 'Ubuhinzi bw\'Icyayi'), 
    ...
    Federation = SelectField(
        'Hitamo Federasiyo ya Union',
        choices=[])

    # Federation = SelectField(
    #     'Hitamo Union Union ibarizwamo',
    #     choices=[('Hitamo Union Union ibarizwamo', 'Hitamo Union Union ibarizwamo'),('UCTHEN', 'UCTHEN'), 
    #     ('UCTCCN', 'UCTCCN'), ('UCOTHENYU', 'UCOTHENYU'),
    #     ('UCOTHEI', 'UCOTHEI'), ('UCOTHESN', 'UCOTHESN')])
    Description = TextAreaField('Ubundi busobanuro bwa Union (Si ngombwa)', render_kw={"placeholder": "Ubundi busobanuro bwa Union (Si ngombwa)"})
    submit = SubmitField('Injiza muri sisiteme')


class newUnionForm(FlaskForm):
    """
    Form for admin to add or edit a department
    """
    Name = StringField(Markup('<b>Izina rya Union</b>'), validators=[DataRequired()], render_kw={"placeholder": "Injiza izina rya Union"})
    Province = SelectField(
        Markup('<b>Intara Union ibarizwamo</b>'),
        choices=[('', ''),('Kigali_City', 'Kigali_City'), 
        ('East', 'East'), ('West', 'West'),
    ...
    #             return Pro
    District = SelectField(
        Markup('<b>Akarere Union ibarizwamo</b>'), 
        choices=[],id='District')
    Sector = StringField(Markup('<b>Injiza umurenge Union ibarizwamo</b>'), validators=[DataRequired()], render_kw={"placeholder": "Injiza umurenge Union ibarizwamo"})
    Cell = StringField(Markup('<b>Injiza akagari Union ibarizwamo</b>'), validators=[DataRequired()], render_kw={"placeholder": "Injiza akagari Union ibarizwamo"})
    ...
    Activity = SelectField(
        Markup('<b>Icyo Union Ikora</b>'),
        choices=[('Tea', 'Tea'),('Coffee', 'Coffee'), 
        ('Rice', 'Rice')],id='Activity')

    Federation = SelectField(
        'Hitamo Federasiyo ya Union',
        choices=[],id='federation')
