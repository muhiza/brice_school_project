...
Revision ID: 09ea3ebcdf48
Revises: 
Create Date: 2019-02-18 19:29:40.034468
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('AmandeC', sa.Integer(), nullable=True),
    ...
    sa.Column('UwoAsigaranye', sa.Integer(), nullable=True),
